...
export class WorkorderComponent {
  ...
  public workorders = signal<WorkOrderItem[]>([
    { woNo: 'WO-2026-001', customer: 'Apex Global Energy Solutions LLC', assetTag: 'EQ-TEMP-002', instrument: 'Precision Temp Calibrator', assignedTech: 'Alex Rivera', dueDate: '2026-08-15', status: 'IN_PROGRESS' },
  ...
  saveJob() {
    ...
    const newNo = `WO-2026-0${this.workorders().length + 11}`;
    this.workorders.update(list => [
      {
        woNo: newNo,
        customer: 'Apex Global Energy Solutions LLC',
